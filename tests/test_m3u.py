...
def write_extvdj_m3u8(m3u):
    ...
    with open(m3u, 'w', encoding='utf-8') as m3ufn:
        ...
        m3ufn.write(f'<artist>Kid \'N Play</artist><title>Can You Dig That</title>{os.linesep}')
        m3ufn.write(f'netsearch://dz85144450{os.linesep}')
        m3ufn.write('#EXTVDJ:<time>21:45</time><lastplaytime>1674884707</lastplaytime>')
...
def write_extvdj_ampersand(m3u):
    ''' create m3u file with VDJ '''
    with open(m3u, 'w', encoding='utf-8') as m3ufn:
        m3ufn.write('#EXTVDJ:<time>08:43</time><lastplaytime>1675701805</lastplaytime>')
